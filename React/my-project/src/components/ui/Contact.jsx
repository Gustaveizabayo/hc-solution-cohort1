...
const Contact = () => {
    return (
        <section id="contact" className="max-w-7xl mx-auto px-4 md:px-8 py-16 md:py-24 text-center">
            <div className="max-w-3xl mx-auto flex flex-col items-center gap-8 border-b border-gray-200 pb-24">
                ...
                <button className="bg-[#e4ebce] text-black px-12 md:px-60 py-4 rounded-full font-bold text-[13px] tracking-wide flex items-center gap-2 hover:bg-[#d6dea4] transition shadow-lg shadow-[#3e5218]/20">
                    Learn More
